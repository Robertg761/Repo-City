/*
 * TEST ONLY. A frozen copy of `lib/client/entities.ts` as it stood before the
 * resolver moved onto the shared entity index (PLAN.md 76.9, commit 0116624).
 * `entities.index.test.ts` holds the new resolver to its answers. Do not edit
 * it to match new behaviour; delete it once the index has shipped for a while.
 */
